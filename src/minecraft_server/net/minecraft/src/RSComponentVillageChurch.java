...
public class RSComponentVillageChurch extends RSComponentVillage
{
    private int averageGroundLevel = -1;

    public RSComponentVillageChurch(RSComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static RSComponentVillageChurch func_74919_a(RSComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(par3, par4, par5, 0, 0, 0, 16, 28, 22, par6);
        return canVillageGoDeeper(var8) && StructureComponent.findIntersecting(par1List, var8) == null ? new RSComponentVillageChurch(par0ComponentVillageStartPiece, par7, par2Random, var8, par6) : null;
    }
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        //Base trim
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 3, 0, 3, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 2, 0, 2, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 1, 0, 3, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 1, 0, 5, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 1, 0, 9, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 1, 0, 13, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 1, 0, 17, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 1, 0, 19, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 2, 0, 19, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 2, 0, 20, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 3, 0, 19, par3StructureBoundingBox);

		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 9, 0, 3, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 10, 0, 2, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 11, 0, 3, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 11, 0, 5, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 11, 0, 9, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 13, 0, 12, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 14, 0, 13, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 14, 0, 17, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 13, 0, 18, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 11, 0, 19, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 10, 0, 19, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 10, 0, 20, par3StructureBoundingBox);
		this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 9, 0, 19, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 4, 0, 0, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 4, 0, 1, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 8, 0, 0, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 8, 0, 1, par3StructureBoundingBox);

        this.fillWithMetadataBlocksIfEmpty(par1World, par3StructureBoundingBox, 1, 0, 3, 1, 0, 18, RSDecoIntegration.stoneSlab2.blockID, 4);
        this.fillWithMetadataBlocksIfEmpty(par1World, par3StructureBoundingBox, 11, 0, 3, 11, 0, 18, RSDecoIntegration.stoneSlab2.blockID, 4);
        this.fillWithMetadataBlocksIfEmpty(par1World, par3StructureBoundingBox, 2, 0, 2, 10, 0, 2, RSDecoIntegration.stoneSlab2.blockID, 4);
        
        //Wall braces
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 2, 1, 3, 2, 7, 3, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 10, 1, 3, 10, 7, 3, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 2, 1, 19, 2, 7, 19, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 10, 1, 19, 10, 7, 19, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 4, 1, 1, 4, 4, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 8, 1, 1, 8, 4, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
		...
		//Roof trim
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 1, 6, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 1, 6, 4, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 1, 6, 5, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 1, 6, 6, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 1, 6, 7, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 1, 6, 8, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 1, 6, 9, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 1, 6, 10, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 1, 6, 11, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 1, 6, 12, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 1, 6, 13, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 1, 6, 14, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 1, 6, 15, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 1, 6, 16, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 1, 6, 17, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 1, 6, 18, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 1, 6, 19, par3StructureBoundingBox);

		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 11, 6, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 11, 6, 4, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 11, 6, 5, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 11, 6, 6, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 11, 6, 7, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 11, 6, 8, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 11, 6, 9, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 11, 6, 10, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 11, 6, 11, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 11, 6, 12, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 12, 6, 12, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 13, 6, 12, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 14, 6, 13, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 14, 6, 14, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 14, 6, 15, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 14, 6, 16, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 14, 6, 17, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 13, 6, 18, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 12, 6, 18, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 11, 6, 18, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 11, 6, 19, par3StructureBoundingBox);
        ...
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 3, 7, 4, 9, 7, 4, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        ...
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 6, 5, 4, 6, 13, 4, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 5, 5, 4, 7, 5, 4, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 4, 1, 4, 4, 4, 4, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 8, 1, 4, 8, 4, 4, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);

		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 2, 8, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 2, 9, 3, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 3, 8, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 0) + 4, 3, 9, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 3, 10, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 3, 11, 3, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 4, 10, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 0) + 4, 4, 11, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 4, 12, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 4, 13, 3, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 5, 12, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 0) + 4, 5, 13, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 5, 14, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 5, 15, 3, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 6, 14, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothMouldingandDecorative.blockID, 12, 6, 15, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 6, 16, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 6, 17, 3, par3StructureBoundingBox);

		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 10, 8, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 10, 9, 3, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 9, 8, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 1) + 4, 9, 9, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 9, 10, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 9, 11, 3, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 8, 10, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 1) + 4, 8, 11, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 8, 12, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 8, 13, 3, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 7, 12, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 1) + 4, 7, 13, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 7, 14, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 7, 15, 3, par3StructureBoundingBox);
        ...
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 4, 1, 18, 8, 6, 18, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 5, 7, 18, 7, 8, 18, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 6, 9, 18, 6, 14, 18, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);

		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 2, 8, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 2, 9, 19, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 3, 8, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 0) + 4, 3, 9, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 3, 10, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 3, 11, 19, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 4, 10, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 0) + 4, 4, 11, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 4, 12, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 4, 13, 19, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 5, 12, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 0) + 4, 5, 13, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 5, 14, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 5, 15, 19, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 6, 14, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothMouldingandDecorative.blockID, 12, 6, 15, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 6, 16, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 6, 17, 19, par3StructureBoundingBox);

		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 10, 8, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 10, 9, 19, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 9, 8, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 1) + 4, 9, 9, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 9, 10, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 9, 11, 19, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 8, 10, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 1) + 4, 8, 11, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 8, 12, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 8, 13, 19, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 7, 12, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 1) + 4, 7, 13, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 7, 14, 19, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 7, 15, 19, par3StructureBoundingBox);

		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 2) + 4, 5, 1, 18, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 2) + 4, 6, 1, 18, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 2) + 4, 7, 1, 18, par3StructureBoundingBox);
		
		//Roof face small
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 4, 5, 1, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 4, 6, 1, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 5, 5, 1, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 0) + 4, 5, 6, 1, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 5, 7, 1, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 5, 8, 1, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 6, 7, 1, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothMouldingandDecorative.blockID, 12, 6, 8, 1, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 6, 9, 1, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 6, 10, 1, par3StructureBoundingBox);

		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 8, 5, 1, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 8, 6, 1, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 7, 5, 1, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 1) + 4, 7, 6, 1, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 7, 7, 1, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 7, 8, 1, par3StructureBoundingBox);
		
		//Roof upper trim
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 6, 13, 4, 6, 13, 18, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 6, 14, 7, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 6, 15, 7, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 6, 14, 11, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 6, 15, 11, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 6, 14, 15, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneSlab2.blockID, 4, 6, 15, 15, par3StructureBoundingBox);

        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 6, 6, 2, 6, 6, 3, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 2, 8, 4, 2, 8, 18, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 2) + 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 2) + 12, false);
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 3, 10, 4, 3, 10, 18, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 2) + 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 2) + 12, false);
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 4, 12, 4, 4, 12, 18, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 2) + 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 2) + 12, false);
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 10, 8, 4, 10, 8, 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 12, false);
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 9, 10, 4, 9, 10, 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 12, false);
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 8, 12, 4, 8, 12, 18, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 12, false);
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 10, 8, 18, 10, 8, 18, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 12, false);
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 9, 10, 18, 9, 10, 18, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 12, false);
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 4, 5, 2, 4, 5, 3, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 2) + 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 2) + 12, false);
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 8, 5, 2, 8, 5, 3, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 12, false);
        ...
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 10, 9, 12, 13, 9, 12, RSDecoIntegration.stoneSlab2.blockID, 4, RSDecoIntegration.stoneSlab2.blockID, 4, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 14, 9, 13, 14, 9, 17, RSDecoIntegration.stoneSlab2.blockID, 4, RSDecoIntegration.stoneSlab2.blockID, 4, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 10, 9, 18, 13, 9, 18, RSDecoIntegration.stoneSlab2.blockID, 4, RSDecoIntegration.stoneSlab2.blockID, 4, false);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 13, 11, 13, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 13, 14, 13, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 13, 11, 17, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 13, 14, 17, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 9, 11, 13, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 9, 14, 13, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 9, 11, 17, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 9, 14, 17, par3StructureBoundingBox);
		...
		//Tower roof
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 10, 16, 12, 12, 16, 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 1) + 8, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 1) + 8, false);
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 10, 16, 18, 12, 16, 18, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 0) + 8, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 0) + 8, false);
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 8, 16, 14, 8, 16, 16, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 2) + 8, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 2) + 8, false);
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 14, 16, 14, 14, 16, 16, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 8, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 8, false);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.strippedLog.blockID, 1, 10, 20, 14, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.strippedLog.blockID, 1, 12, 20, 16, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.strippedLog.blockID, 1, 12, 20, 14, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.strippedLog.blockID, 1, 10, 20, 16, par3StructureBoundingBox);

		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 1) + 12, 11, 18, 12, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 1) + 12, 10, 19, 13, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 1) + 12, 12, 19, 13, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 1) + 12, 11, 20, 13, par3StructureBoundingBox);

		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 0) + 12, 11, 18, 18, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 0) + 12, 10, 19, 17, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 0) + 12, 12, 19, 17, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 0) + 12, 11, 20, 17, par3StructureBoundingBox);

		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 2) + 12, 8, 18, 15, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 2) + 12, 9, 19, 14, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 2) + 12, 9, 19, 16, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 2) + 12, 9, 20, 15, par3StructureBoundingBox);

		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 12, 14, 18, 15, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 12, 13, 19, 14, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 12, 13, 19, 16, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 12, 13, 20, 15, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 11, 27, 15, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 0) + 4, 2, 1, 7, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 0) + 4, 2, 1, 11, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 0) + 4, 2, 1, 15, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 1) + 4, 10, 1, 7, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 1) + 4, 10, 1, 11, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 1) + 4, 13, 1, 15, par3StructureBoundingBox);
		...
		//Windows
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 2, 2, 6, 2, 4, 8, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 2, 5, 7, par3StructureBoundingBox);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 2, 2, 10, 2, 4, 12, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 2, 5, 11, par3StructureBoundingBox);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 2, 2, 14, 2, 4, 16, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 2, 5, 15, par3StructureBoundingBox);

        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 10, 2, 6, 10, 4, 8, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 10, 5, 7, par3StructureBoundingBox);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 10, 2, 10, 10, 4, 12, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 10, 5, 11, par3StructureBoundingBox);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 13, 2, 14, 13, 4, 16, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 13, 5, 15, par3StructureBoundingBox);

        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 9, 7, 13, 13, 8, 13, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 13, 7, 13, 13, 8, 17, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 9, 7, 17, 13, 8, 17, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);

        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 10, 13, 13, 12, 15, 13, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 11, 12, 13, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 11, 16, 13, par3StructureBoundingBox);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 10, 13, 17, 12, 15, 17, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 11, 12, 13, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 11, 16, 13, par3StructureBoundingBox);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 9, 13, 14, 9, 15, 16, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 9, 12, 15, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 9, 16, 15, par3StructureBoundingBox);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 13, 13, 14, 13, 15, 16, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 13, 12, 15, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.stoneTypesSmooth.blockID, 1, 13, 16, 15, par3StructureBoundingBox);
		
		if (this.startPiece.GetAbandonmentLevel(par1World) == 0) {
	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 2, 2, 7, 2, 4, 7, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);
	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 2, 2, 11, 2, 4, 11, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);
	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 2, 2, 15, 2, 4, 15, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);

	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 10, 2, 7, 10, 4, 7, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);
	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 10, 2, 11, 10, 4, 11, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);
	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 13, 2, 15, 13, 4, 15, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);

	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 10, 7, 13, 10, 8, 13, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);
	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 12, 7, 13, 12, 8, 13, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);
	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 13, 7, 14, 13, 8, 14, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);
	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 13, 7, 16, 13, 8, 16, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);
	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 10, 7, 17, 10, 8, 17, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);
	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 12, 7, 17, 12, 8, 17, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);

	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 11, 13, 13, 11, 15, 13, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);
	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 11, 13, 17, 11, 15, 17, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);
	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 9, 13, 15, 9, 15, 15, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);
	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 13, 13, 15, 13, 15, 15, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);

	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 5, 2, 18, 7, 6, 18, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);
	        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 6, 7, 18, 6, 8, 18, RSDecoIntegration.glassStained.blockID, 6, RSDecoIntegration.glassStained.blockID, 6, false);
		}
		else {
			...
			this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.glassStained.blockID, 6, 5, 2, 18, par3StructureBoundingBox);
			this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.glassStained.blockID, 6, 5, 5, 18, par3StructureBoundingBox);
			this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.glassStained.blockID, 6, 5, 6, 18, par3StructureBoundingBox);
			this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.glassStained.blockID, 6, 7, 2, 18, par3StructureBoundingBox);
			this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.glassStained.blockID, 6, 7, 3, 18, par3StructureBoundingBox);
			this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.glassStained.blockID, 6, 7, 6, 18, par3StructureBoundingBox);
			this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.glassStained.blockID, 6, 6, 8, 18, par3StructureBoundingBox);
		}
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 4, 2, 0, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, Block.cobblestoneWall.blockID, 0, 8, 1, 0, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherrySidingAndCorner.blockID, 14, 8, 2, 0, par3StructureBoundingBox);
		
		if (this.startPiece.GetAbandonmentLevel(par1World) <= 1) {
			this.placeDoorAtCurrentPosition(par1World, par3StructureBoundingBox, par2Random, 6, 1, 2, 0, (BlockDoor) RSDecoIntegration.doorSpruce);
		}
		else {
        ...
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 3, 1, 6, 9, 1, 6, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 1) + 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 1) + 12, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 3, 1, 8, 9, 1, 8, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 1) + 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 1) + 12, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 3, 1, 10, 9, 1, 10, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 1) + 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 1) + 12, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 3, 1, 12, 9, 1, 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 1) + 12, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 1) + 12, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 6, 1, 6, 6, 1, 13, 0, 0, false);

        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 4, 1, 17, 8, 1, 17, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 0), 4, 1, 16, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 3), 5, 1, 16, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 3), 7, 1, 16, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.andesiteSmoothStairs.blockID, this.getMetadataWithOffset(RSDecoIntegration.andesiteSmoothStairs.blockID, 1), 8, 1, 16, par3StructureBoundingBox);
        
		//Inner wall braces
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 3, 1, 5, 3, 7, 5, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 3, 1, 9, 3, 7, 9, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 3, 1, 13, 3, 7, 13, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 3, 1, 17, 3, 7, 17, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);

        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 9, 1, 5, 9, 7, 5, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 9, 1, 9, 9, 7, 9, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 9, 1, 13, 9, 7, 13, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
        this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 9, 1, 17, 9, 7, 17, RSDecoIntegration.stoneTypesSmooth.blockID, 1, RSDecoIntegration.stoneTypesSmooth.blockID, 1, false);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 1) + 8, 10, 11, 16, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.trapdoorSpruce.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorSpruce.blockID, 3) + 12, 11, 12, 16, par3StructureBoundingBox);
