...
public class RSComponentVillageStartPiece extends RSComponentVillageWell
{
    ...
    public RSComponentVillageStartPiece(WorldChunkManager par1WorldChunkManager, int par2, Random par3Random, int par4, int par5, ArrayList par6ArrayList, int par7)
    {
        super((RSComponentVillageStartPiece)null, 0, par3Random, par4, par5);
