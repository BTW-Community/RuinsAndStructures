...
public class RSComponentVillageWoodHut extends RSComponentVillage
{
	private int averageGroundLevel = -1;
	private final int tablePosition;

	public RSComponentVillageWoodHut(RSComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
	{
	...
	public static RSComponentVillageWoodHut func_74908_a(RSComponentVillageStartPiece startPiece, List boundingBoxList, Random rand, int x, int y, int z, int par6, int par7)
	{
		StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(x, y, z, 0, 0, 0, 7, 7, 7, par6);
		return canVillageGoDeeper(var8) && StructureComponent.findIntersecting(boundingBoxList, var8) == null ? new RSComponentVillageWoodHut(startPiece, par7, rand, var8, par6) : null;
	}
	...
	public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
	{
		...
		this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 1, 1, 5, 3, 5, RSDecoIntegration.barkLogStripped.blockID, RSDecoIntegration.barkLogStripped.blockID, false);
		...
		//Base supports
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.strippedLog.blockID, 1, 0, 0, 1, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.strippedLog.blockID, 1, 0, 0, 5, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.strippedLog.blockID, 1, 6, 0, 1, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.strippedLog.blockID, 1, 6, 0, 5, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.strippedLog.blockID, 1, 1, 0, 6, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.strippedLog.blockID, 1, 5, 0, 6, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.strippedLog.blockID, 1, 1, 0, 0, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.strippedLog.blockID, 1, 5, 0, 0, par3StructureBoundingBox);
		...
		//Trapdoor rim
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 0, 3, 1, 0, 3, 5, RSDecoIntegration.trapdoorCherry.blockID, 9, RSDecoIntegration.trapdoorCherry.blockID, 9, false);
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 6, 3, 1, 6, 3, 5, RSDecoIntegration.trapdoorCherry.blockID, 9, RSDecoIntegration.trapdoorCherry.blockID, 9, false);
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 1, 3, 6, 5, 3, 6, RSDecoIntegration.trapdoorCherry.blockID, 9, RSDecoIntegration.trapdoorCherry.blockID, 9, false);
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 1, 3, 0, 5, 3, 0, RSDecoIntegration.trapdoorCherry.blockID, 9, RSDecoIntegration.trapdoorCherry.blockID, 9, false);

		//Front facade
		//Door
		if (this.startPiece.GetAbandonmentLevel(par1World) <= 1) {
			this.placeDoorAtCurrentPosition(par1World, par3StructureBoundingBox, par2Random, 3, 1, 1, 3, (BlockDoor) RSDecoIntegration.doorSpruce);
		}
		else {
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.pergola.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 3), 2, 3, 0, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.pergola.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 3), 3, 3, 0, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.pergola.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 3), 4, 3, 0, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 3), 0, 4, 1, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 3), 0, 5, 2, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 2) + 4, 0, 4, 2, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 3), 6, 4, 1, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 3), 6, 5, 2, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 2) + 4, 6, 4, 2, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 3) + 4, 3, 5, 0, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 3) + 4, 3, 6, -1, par3StructureBoundingBox);

		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 2), 0, 4, 5, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 2), 0, 5, 4, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 3) + 4, 0, 4, 4, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 2), 6, 4, 5, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 2), 6, 5, 4, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 3) + 4, 6, 4, 4, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 2) + 4, 3, 5, 6, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 2) + 4, 3, 6, 7, par3StructureBoundingBox);

		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 0), 1, 4, 0, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 0), 2, 5, 0, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 1) + 4, 2, 4, 0, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 0), 1, 4, 6, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 0), 2, 5, 6, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 1) + 4, 2, 4, 6, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 0) + 4, 0, 5, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 0) + 4, -1, 6, 3, par3StructureBoundingBox);

		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 1), 5, 4, 0, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 1), 4, 5, 0, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 0) + 4, 4, 4, 0, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 1), 5, 4, 6, par3StructureBoundingBox);
		...
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 1), 4, 5, 6, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 0) + 4, 4, 4, 6, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 1) + 4, 6, 5, 3, par3StructureBoundingBox);
		this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.cherryStairs.blockID, this.getMetadataWithOffset(Block.stairsWoodSpruce.blockID, 1) + 4, 7, 6, 3, par3StructureBoundingBox);
		...
		if (this.startPiece.GetAbandonmentLevel(par1World) == 0) {
			this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.glassStained.blockID, 3, 1, 2, 3, par3StructureBoundingBox);
			this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.glassStained.blockID, 3, 5, 2, 3, par3StructureBoundingBox);
		}
		else {
		...
		if (this.tablePosition == 0) {
			...
			this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.oakWoodChair.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorCherry.blockID, 0) + 2, 4, 1, 3, par3StructureBoundingBox);
			...
			this.placeBlockAtCurrentPosition(par1World, RSDecoIntegration.oakWoodChair.blockID, this.getMetadataWithOffset(RSDecoIntegration.trapdoorCherry.blockID, 0) + 2, 2, 1, 3, par3StructureBoundingBox);
        ...
        this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.strippedLog.blockID, 1, 0, -1, 1, par3StructureBoundingBox);
        this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.strippedLog.blockID, 1, 0, -1, 5, par3StructureBoundingBox);

        this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.strippedLog.blockID, 1, 6, -1, 1, par3StructureBoundingBox);
        this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.strippedLog.blockID, 1, 6, -1, 5, par3StructureBoundingBox);

        this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.strippedLog.blockID, 1, 1, -1, 6, par3StructureBoundingBox);
        this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.strippedLog.blockID, 1, 5, -1, 6, par3StructureBoundingBox);

        this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.strippedLog.blockID, 1, 1, -1, 0, par3StructureBoundingBox);
        this.fillCurrentPositionBlocksDownwards(par1World, RSDecoIntegration.strippedLog.blockID, 1, 5, -1, 0, par3StructureBoundingBox);
